...
const SignOutIcon = ({ width = 496, height = 504, fill = 'black' }) => {
  ...
  return (
    <svg onClick={logout} width={width} height={height} className="cursor-pointer"  viewBox="0 0 496 504" fill="none" xmlns="http://www.w3.org/2000/svg">
